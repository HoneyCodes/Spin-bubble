...
int main ()
{
  ...
  for(i = 0; i < nodes; i++)
  {
    ...
    state_sz->data.push_back ({rand (), rand (), rand (), rand ()});                                // Setting state_sz seed...
  ...
  while(!gl->closed ())                                                                             // Opening window...
  {
    ...
    if(ImGui::Button ("(R)estart") || gl->button_TRIANGLE || gl->key_R)
    {
      ...
      sz->data       = initial_sz;                                                                  // Restoring backup...
  ...
  delete sz;                                                                                        // Deleting z-spin...
  delete state_sz;                                                                                  // Deleting random generator state...
  delete state_th;                                                                                  // Deleting random generator state...
