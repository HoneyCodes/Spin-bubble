...
int main ()
{
  ...
  for(i = 0; i < nodes; i++)
  {
    ...
    theta->data.push_back ((3.0f/2.0f)*M_PI);                                                       // Setting initial z-spin...
    theta_int->data.push_back (0.0f);                                                               // Setting initial z-spin (intermediate value)...
  ...
  while(!gl->closed ())                                                                             // Opening window...
  {
    ...
    if(ImGui::Button ("(R)estart") || gl->button_TRIANGLE || gl->key_R)
    {
      ...
      theta->data    = initial_theta;                                                               // Restoring backup...
