...
int main ()
{
  ...
  nu::int4*                        state_x        = new nu::int4 (5);                               // Random generator state.
  nu::int4*                        state_y        = new nu::int4 (6);                               // Random generator state.
  nu::float1*                      dt             = new nu::float1 (7);                             // Time step [s].
  ...
  for(i = 0; i < nodes; i++)
  {
    ...
    state_x->data.push_back ({int(234 + i), int(545 + 2*i), int(6 + 4*i), int(645 + i)});
    state_y->data.push_back ({int(214 + i), int(525 + 2*i), int(5 + 4*i), int(635 + i)});
  ...
  delete state_x;                                                                                   // Deleting random generator state...
  delete state_y;                                                                                   // Deleting random generator state...
