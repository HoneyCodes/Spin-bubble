...
{ 
  ...
  do
  {
    ...
    th_rand = uint_to_float(xoshiro128pp(&st_th), -1.0f, +1.0f);                // Generating random threshold (flat distribution)...
  ...
  sz[n] = sz_rand;                                                              // Setting new z-spin...
  ...
  p.z = 0.05f*sz_rand;                                                          // Setting new z position...
